...
public class PessoaController {
	...
	@PostMapping("/save")
	public ResponseEntity<?> save(@RequestBody Pessoa pessoa, @RequestParam long usuario_id) {
		
		Pessoa _pessoa = pessoaService.save(pessoa, usuario_id);
		
		return ResponseEntity.ok().body(new MessageResponse("Dados salvos com sucesso"));
	}
